    ...
    <SectionProvider id="hero">
      ...
      <div className="relative flex justify-center mt-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[50vw] flex flex-col items-center justify-center">
          <h2 className="uppercase tracking-widest border border-blue-100/[0.2] rounded-full px-5 py-1 bg-gradient-to-br from-[#191c2f] to-slate-800 text-sm text-center dark:text-blue-100 text-blue-900">
            <span className="text-yellow-400">&#10023;</span> MULTI-DIGITAL SOLUTION AGENCY{" "}
